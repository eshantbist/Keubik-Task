...
export default class UpdateAddress extends Component{
    ...
    state={
        type:this.props.navigation.state.params.item.fields.type,
        name:this.props.navigation.state.params.item.fields.name,
        phone:this.props.navigation.state.params.item.fields.phone,
        address1:this.props.navigation.state.params.item.fields.address1,
        address2:this.props.navigation.state.params.item.fields.address2,
        address3:this.props.navigation.state.params.item.fields.address3,
        pinCode:this.props.navigation.state.params.item.fields.pincode,
        city:this.props.navigation.state.params.item.fields.city,
        state:this.props.navigation.state.params.item.fields.state,
        country:this.props.navigation.state.params.item.fields.country,
        title:this.props.navigation.state.params.item.fields.title,
        loading:false
    }
        ...
        return(
            <Container style={{marginHorizontal:10}}>
                <Content>
                    ...
                    <TouchableOpacity onPress={()=>{this.updateAddress()}} style={styles.addButton}>
